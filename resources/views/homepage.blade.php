    ...
    <section class="px-4 py-16 mx-auto max-w-6xl">
        ...
        <div class="grid grid-cols-1 gap-10 md:grid-cols-3">
            <div class="p-6 bg-white rounded-lg shadow-2xl transition-transform transform hover:scale-105">
                <i class="mb-4 text-4xl text-blue-500 iconoir-music-note" aria-hidden="true"></i>
            ...
            <div class="p-6 bg-white rounded-lg shadow-2xl transition-transform transform hover:scale-105">
                <i class="mb-4 text-4xl text-blue-500 iconoir-calendar" aria-hidden="true"></i>
            ...
            <div class="p-6 bg-white rounded-lg shadow-2xl transition-transform transform hover:scale-105">
                <i class="mb-4 text-4xl text-blue-500 iconoir-check-circle" aria-hidden="true"></i>
